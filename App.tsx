    ...
    <div className="min-h-screen bg-slate-50 flex flex-col items-center p-4 md:p-8">
      <div className="w-full max-w-md">
        ...
        <footer className="mt-12 text-center text-slate-400 text-xs pb-8">
          <p>© 2026 ZapLink Pro. Simples, Rápido e Moderno. Desenvolvido por <a href="https://ridolfiweb.com.br" target="_blank" rel="noopener noreferrer" className="hover:text-slate-300 transition-colors">RidolfiWEB</a></p>
